...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE matkuldb SET matkul='$matkul', deskripsi='$deskripsi', materi1='$materi1', materi2='$materi2', materi3='$materi3', materi4='$materi4', materi5='$materi5', materi6='$materi6', materi7='$materi7', materi8='$materi8', materi9='$materi9', materi10='$materi10', materi11='$materi11', materi12='$materi12', materi13='$materi13', materi14='$materi14'";
    $query = mysqli_query($connect, $sql);

    if ($query) {
        header('location: ../list.php'); // Redirect to the view page after updating
    } else {
